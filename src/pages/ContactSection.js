    ...
    <>
      ...
      <Box sx={{ bgcolor: "none" }}>
        <Container sx={{ maxWidth: "1400px !important" }}>
          ...
          >
            {/* Left Side Content */}
            <Box flex="1 1 43%" minWidth="300px">
              <Typography
                variant="h1"
                gutterBottom
                sx={{
              ...
              <Box data-aos="fade-up" data-aos-duration="1400">
                <Box display="flex" alignItems="center" gap={2} mb={2}>
                  <Box
                    ...
                    onClick={() => {
                      window.location.href = "tel:+919550420469";
                    }}
                  >
                    <PhoneIcon />
                  </Box>
                  <Box >
                    ...
                    <Typography variant="body2">+91 9550420469</Typography>
                  </Box>
                </Box>
              </Box>
              ...
              >
                <Box
                  ...
                  onClick={() => {
                    window.location.href =
                      "mailto:info@coregent.com?subject=Hello&body=I would like to contact you.";
                  }}
                >
                  <EmailIcon />
                </Box>
                <Box>
                  ...
                  <Typography variant="body2" sx={{ fontFamily: "Mohave" }}>info@coregent.com</Typography>
                </Box>
              </Box>
